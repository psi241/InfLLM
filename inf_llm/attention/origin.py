...
def origin_forward(fattn: bool, *args, **kwargs):
    def forward(self, query : torch.Tensor,
        ...
        if fattn:
            ...
            # Consult with generative AI for fixing
            k_expanded = h_k.unsqueeze(2)     # (batch_size, num_heads_kv, 1, len_k, dim_head)
            k_expanded = k_expanded.repeat(1, 1, num_heads // num_heads_kv, 1, 1)  # (batch_size, num_heads_kv, rep, len_k, dim_head), rep = num_heads // num_heads_kv
            k_expanded = k_expanded.view(batch_size, num_heads, len_k, dim_head)     # (batch_size, num_heads_kv, 1, len_k, dim_head)
            ...
            # Don't forget to normalize the attention
            ...
            score = score.to(v_expanded.dtype)
